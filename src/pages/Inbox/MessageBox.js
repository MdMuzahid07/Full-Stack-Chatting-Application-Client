...
const MessageBox = () => {
    return (
        <section className="d-flex">
            <div>
                <img className="border border-2 border-dark img-custom" style={{ height: "50px", width: "50px", borderRadius: "50%" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIi_a9WP926ruhJ1h6znk6nYQndHRnQ995Ig&usqp=CAU" alt="" />
            ...
            <div
                ...
                className="p-2 my-3 ms-4 rounded-3 text-light"
            >
                <div style=
                    {{
                        minHeight: "30px",
                ...
                >
                    <div>
                        <p><small>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum, dicta nndis maxime ab maiores. Enim, nemo. Tempore, id.</small></p>
                    </div>
                </div>
            </div>
            <span className="mt-3">
